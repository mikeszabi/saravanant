...
data = urllib.urlopen('http://stats.wordpress.com/csv.php?api_key=apiKeyOfYourBlog&blog_id=blogId&table=postviews&days=2&limit=-1').read()
fileObj = open("filePath/blogPostViews.csv", "a")
...
#Format date,post_id,post_title,post_permalink,views
for line in dataArr:
	try :
