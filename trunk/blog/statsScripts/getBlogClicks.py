...
data = urllib.urlopen('http://stats.wordpress.com/csv.php?api_key=apiKeyOfYourBlog&blog_id=blogId&table=clicks&days=2&limit=-1').read()
fileObj = open("filePath/blogClicks.csv", "a")
